 ...
 * @author Ace Yan
 * @github githubyss
 * @createdTime 2022/10/09 16:22:47
 */
class ThemeDefaultTransparentWindowActivity : BaseReflectBindingViewModelToolbarActivity<ComresActivityThemeSampleBinding>() {
