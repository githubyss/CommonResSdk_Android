 ...
 */
class ThemeDefaultTransparentWindowStatusNavigationActivity : BaseReflectBindingViewModelToolbarActivity<ComresActivityThemeSampleToolbarBinding>() {
    ...
    override fun setToolbarTitle() {
        setToolbarTitle("全透明窗口 ＋ 全透明状态栏、导航栏")
    }
}