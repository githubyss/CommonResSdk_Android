...
/**
 * ThemeDefaultTransparentWindowStatusNavigationActivity
 *
 * @author Ace Yan
 * @github githubyss
 * @createdTime 2022/10/09 16:24:42
 */
class ThemeDefaultTransparentWindowStatusNavigationActivity : BaseReflectBindingViewModelToolbarActivity<ComresActivityThemeSampleBinding>() {

    /** ****************************** Companion ****************************** */

    /**  */
    companion object {
        private val TAG: String = ThemeDefaultTransparentWindowStatusNavigationActivity::class.java.simpleName
    }
}