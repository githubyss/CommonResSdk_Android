 ...
 */
class ThemeDefaultTransparentWindowExtendStatusActivity : BaseReflectBindingViewModelToolbarActivity<ComresActivityThemeSampleToolbarBinding>() {

    /** ****************************** Companion ****************************** */

    /**  */
    companion object {
        private val TAG: String = ThemeDefaultTransparentWindowExtendStatusActivity::class.java.simpleName
    }
    ...
    override fun setToolbarTitle() {
        setToolbarTitle("全透明窗口 ＋ 界面延伸到状态栏")
    }
}