...
/**
 * ThemeDefaultTransparentWindowExtendNavigationActivity
 *
 * @author Ace Yan
 * @github githubyss
 * @createdTime 2022/10/09 16:23:09
 */
class ThemeDefaultTransparentWindowExtendNavigationActivity : BaseReflectBindingViewModelToolbarActivity<ComresActivityThemeSampleBinding>() {

    /** ****************************** Companion ****************************** */

    /**  */
    companion object {
        private val TAG: String = ThemeDefaultTransparentWindowExtendNavigationActivity::class.java.simpleName
    }
}