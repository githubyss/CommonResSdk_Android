 ...
 */
class ThemeDefaultTransparentWindowExtendNavigationActivity : BaseReflectBindingViewModelToolbarActivity<ComresActivityThemeSampleToolbarBinding>() {
    ...
    override fun setToolbarTitle() {
        setToolbarTitle("全透明窗口 ＋ 界面延伸到导航栏")
    }
}