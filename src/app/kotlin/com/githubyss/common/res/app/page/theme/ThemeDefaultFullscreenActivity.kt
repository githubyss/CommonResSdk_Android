...
/**
 * ThemeDefaultFullscreenActivity
 *
 * @author Ace Yan
 * @github githubyss
 * @createdTime 2022/10/09 16:22:24
 */
class ThemeDefaultFullscreenActivity : BaseReflectBindingViewModelToolbarActivity<ComresActivityThemeSampleBinding>() {

    /** ****************************** Companion ****************************** */

    /**  */
    companion object {
        private val TAG: String = ThemeDefaultFullscreenActivity::class.java.simpleName
    }
}